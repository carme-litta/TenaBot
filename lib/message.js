...
exports.FakeStatusImgForwarded = (from, image, caption) => {
	samu330.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '➫𝗔𝘅𝗲𝗹𝘆 𝗙𝗲𝗿𝗻𝗮𝗻𝗱𝗮🔥❣️', "jpegThumbnail": fs.readFileSync(`./src/help.jpeg`)} } }, caption: '𝒩𝓎𝒶𝓃ℬ𝑜𝓉💓', contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
